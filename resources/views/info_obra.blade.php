        ...
        <div class="d-flex justify-content-center mb-5">
            <form action="info_obra/store" method="POST" enctype="multipart/form-data" class="col-12">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="preco" class="form-control {{$errors->has('preco') ? 'is-invalid' : ''}}"
                        placeholder="informe o preço da obra">
                    @if ($errors->has('preco'))
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="obra" class="form-control {{$errors->has('obra') ? 'is-invalid' : ''}} "
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="tamanho"
                            class="form-control {{$errors->has('tamanho') ? 'is-invalid' : ''}}"
                ...
                <div class="custom-file mb-4">
                    <input type="file" class="custom-file-input  {{$errors->has('imagem') ? 'is-invalid' : ''}}"
                        name="imagem" id="imagem" lang="es">
